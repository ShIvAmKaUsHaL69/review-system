...
<div class="d-flex" id="wrapper">
  ...
  <nav id="sidebarMenu" class="bg-dark text-white p-3">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li class="nav-item mb-2"><a href="<?=site_url('submit-complain'); ?>" class="nav-link text-white <?php if(uri_string()==='submit-complain') echo 'active bg-primary';?>"><i class="fa-solid fa-comment-dots me-2"></i>Anonymous</a></li>
    </ul>
    <hr class="text-secondary" />
